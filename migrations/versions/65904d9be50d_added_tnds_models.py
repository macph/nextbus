...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column('code', sa.Text(), nullable=False),
        sa.Column('service_ref', sa.Text(), nullable=False),
        sa.Column('line_ref', sa.Text(), nullable=False),
        sa.Column('pattern_ref', sa.Text(), nullable=False),
    ...
    op.create_table(
        'bank_holidays',
        sa.Column('name', bank_holiday, nullable=False),
        sa.Column('journey_ref', sa.Text(), nullable=False),
        sa.Column('operational', sa.Boolean(), nullable=True),
        sa.ForeignKeyConstraint(['journey_ref'], ['journey.code'], ondelete='CASCADE'),
    ...
    op.create_table(
        'special_period',
        sa.Column('id', sa.Integer(), nullable=False),
        sa.Column('journey_ref', sa.Text(), nullable=True),
        ...
        sa.ForeignKeyConstraint(['journey_ref'], ['journey.code'], ondelete='CASCADE'),
        sa.PrimaryKeyConstraint('id'),
        sa.UniqueConstraint('journey_ref', 'date_start', 'date_end')
    )
    op.create_table(
        'journey_link',
        sa.Column('id', sa.Integer(), nullable=False),
        ...
        sa.Column('route_direction', direction, nullable=False),
